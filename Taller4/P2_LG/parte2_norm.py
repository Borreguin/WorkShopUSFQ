...
Original file is located at
    https://colab.research.google.com/drive/1UotACQnaEYoq7vWbB1r_4F1wfnGW8sQf
"""

from sklearn.metrics import mean_squared_error
from util import *
from utilLinealRegression import gradient_descent, predict, mini_batch_gradient_descent, stochastic_gradient_descent
...
def train_lineal_regression_model(study_case):
    ...
    weights, history = stochastic_gradient_descent(x_train, y_train, learning_rate=0.01, iterations=1000)
    #weights, history = mini_batch_gradient_descent(x_train, y_train, learning_rate=0.01, iterations=1000, batch_size=32)
